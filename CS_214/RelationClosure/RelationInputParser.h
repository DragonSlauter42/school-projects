...
class RelationInputParser
{
	private:
		...
		RelationInputParser();				// Default constructor for singleton
		bool getNextLine(char *buffer, int n);	// Read a line from the data file

	public:
		static RelationInputParser *getInstance();	// Get the singleton instance of this class
		~RelationInputParser();						// Destructor
